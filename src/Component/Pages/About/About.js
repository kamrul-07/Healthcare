    ...
    return (
        <div className="mt-5">
          ...
          <div className=" p-10 relative">
              ...
              <h1 className="rounded-full h-10 w-10 flex  items-center justify-center  bg-yellow-300 text-2xl p-8 mb-5 absolute left-44 -top-7 ">1</h1>
          ...
          <div className=" bg-gray-200 p-10 relative" >
              ...
              <h1 className="rounded-full h-10 w-10 flex  items-center justify-center  bg-yellow-300 p-2 text-2xl p-8 mb-5 absolute left-44 -top-7">2</h1>
          ...
          <div className=" p-10 relative">
              ...
              <h1 className="rounded-full h-10 w-10 flex  items-center justify-center  bg-yellow-300 p-2 text-2xl p-8 mb-5 absolute left-44 -top-7">3</h1>
          ...
          <div>
              <h1 className="text-4xl mb-2 font-bold">Our Values</h1>
              ...
              <div>
                  <div className="grid gap-10 grid-cols-1 md:grid-cols-4 container mx-auto  mt-44 mb-10">
                      <div className="relative p-10">
                          <h1 className="rounded-full h-10 w-10 flex  items-center justify-center  bg-yellow-300 p-2 text-2xl p-8 mb-5 absolute left-28 -top-20"><i className="fas fa-envelope-open-text"></i></h1>
                      ...
                      <div className="relative p-10">
                          <span className="rounded-full h-10 w-10 flex  items-center justify-center  bg-yellow-300 p-2 text-2xl p-8 mb-5 absolute left-28 -top-20"><i className="fas fa-clinic-medical"></i></span>
                      ...
                      <div className="relative p-10">
                          <span className="rounded-full h-10 w-10 flex  items-center justify-center  bg-yellow-300 p-2 text-2xl p-8 mb-5 absolute left-28 -top-20"><i className="fas fa-fist-raised"></i></span>
                          <h1 className="font-bold text-4xl">Respect</h1>

                          <p className="text-xl text-gray-500">We have an array of social, recreational and religious activities within our bright and cheery surroundings that allow residents to enjoy their stay.</p>
                      </div>
                      <div className="relative p-10">
                          <span className="rounded-full h-10 w-10 flex  items-center justify-center  bg-yellow-300 p-2 text-2xl p-8 mb-5 absolute left-28 -top-20"><i className="fas fa-carrot"></i></span>
